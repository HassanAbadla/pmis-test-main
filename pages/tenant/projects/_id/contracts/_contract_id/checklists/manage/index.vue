          ...
          <v-card elevation-3 color="primary" class="white--text">
            ...
            >
              ...
              <template v-slot:item.actions="{ item }">
                ...
                <v-btn icon text v-if="item.is_started == 1" nuxt :to="getStageLink(item)">
...
export default {
  ...
  methods: {
    ...
    saveStages() {
      ;(this.fields.project_stage = this.selected_item.id), (this.fields.contract_id = this.$route.params.id)
      this.fields.project_id = this.contract.project_id
      this.$store.dispatch("projectStages/saveStage", this.fields)
    ...
    getStageLink(item) {
      ...
      return `/tenant/projects/${projectId}/contracts/${contractId}/checklist/manage/stages/${stageId}`
    },
    fetchContract() {
